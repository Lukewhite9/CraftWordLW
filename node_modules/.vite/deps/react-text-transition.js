...
function Me(t, { key: e, props: n2, defaultProps: r2, state: o, actions: s }) {
  return new Promise((i2, a) => {
    var _a2;
    let u4, p3, f3 = te2((_a2 = n2.cancel) != null ? _a2 : r2 == null ? void 0 : r2.cancel, e);
    if (f3)
      b4();
    else {
...
var ue2 = class extends X2 {
  ...
  _stop(e, n2) {
    if (Q4(this)) {
      ...
      let o = n2 ? q(this.get()) : E2(this.get(), Ce2(this, e != null ? e : r2.to));
...
function Gt2(t, e, n2) {
  let r2 = l2.fun(e) && e, { reset: o, sort: s, trail: i2 = 0, expires: a = true, exitBeforeEnter: u4 = false, onDestroyed: p3, ref: f3, config: d4 } = r2 ? r2() : e, m3 = (0, import_react13.useMemo)(() => r2 || arguments.length == 3 ? fe2() : void 0, []), b4 = ht(t), c5 = [], P2 = (0, import_react13.useRef)(null), l4 = o ? null : P2.current;
  Q2(() => {
    P2.current = c5;
  }), $r(() => (Ve(c5, (y5) => {
  ...
  let h5 = tr(b4, r2 ? r2() : e, l4), g3 = o && P2.current || [];
  Q2(() => Ve(g3, ({ ctrl: y5, item: T2, key: F3 }) => {
    xe2(y5, m3), I2(p3, T2, F3);
  }));
  let x4 = [];
  if (l4 && Ve(l4, (y5, T2) => {
    y5.expired ? (clearTimeout(y5.expirationId), g3.push(y5)) : (T2 = x4[T2] = h5.indexOf(y5.key), ~T2 && (c5[T2] = y5));
  }), Ve(b4, (y5, T2) => {
    c5[T2] || (c5[T2] = { key: h5[T2], item: y5, phase: "mount", ctrl: new le2() }, c5[T2].ctrl.item = y5);
  }), x4.length) {
    let y5 = -1, { leave: T2 } = r2 ? r2() : e;
    Ve(x4, (F3, k4) => {
      let O3 = l4[k4];
      ~F3 ? (y5 = c5.indexOf(O3), c5[y5] = { ...O3, item: b4[F3] }) : T2 && c5.splice(++y5, 0, O3);
    });
  }
  l2.fun(s) && c5.sort((y5, T2) => s(y5.item, T2.item));
  let S2 = -i2, A2 = Mr(), V3 = ne3(e), _3 = /* @__PURE__ */ new Map(), v4 = (0, import_react13.useRef)(/* @__PURE__ */ new Map()), w2 = (0, import_react13.useRef)(false);
  Ve(c5, (y5, T2) => {
    let F3 = y5.key, k4 = y5.phase, O3 = r2 ? r2() : e, U2, D3, Jt2 = I2(O3.delay || 0, F3);
    if (k4 == "mount")
    ...
    if (U2 = I2(U2, y5.item, T2), U2 = l2.obj(U2) ? de2(U2) : { to: U2 }, !U2.config) {
      let M2 = d4 || V3.config;
      U2.config = I2(M2, y5.item, T2, D3);
    }
    S2 += i2;
    let Z2 = { ...V3, delay: Jt2 + S2, ref: f3, immediate: O3.immediate, reset: false, ...U2 };
    if (D3 == "enter" && l2.und(Z2.from)) {
      let M2 = r2 ? r2() : e, Te2 = l2.und(M2.initial) || l4 ? M2.from : M2.initial;
      Z2.from = I2(Te2, y5.item, T2);
    }
    let { onResolve: Wt } = Z2;
    Z2.onResolve = (M2) => {
      I2(Wt, M2);
      let Te2 = P2.current, B2 = Te2.find((Fe) => Fe.key === F3);
      if (B2 && !(M2.cancelled && B2.phase != "update") && B2.ctrl.idle) {
        ...
        Fe && Te2.some((ee2) => ee2.expired) && (v4.current.delete(B2), u4 && (w2.current = true), A2());
      }
    };
    let ft2 = _e2(y5.ctrl, Z2);
    D3 === "leave" && u4 ? v4.current.set(y5, { phase: D3, springs: ft2, payload: Z2 }) : _3.set(y5, { phase: D3, springs: ft2, payload: Z2 });
  });
  let C3 = (0, import_react13.useContext)(H3), $2 = Ur(C3), L3 = C3 !== $2 && Ue2(C3);
  Q2(() => {
    L3 && Ve(c5, (y5) => {
    ...
    if (v4.current.size) {
      let F3 = c5.findIndex((k4) => k4.key === T2.key);
      c5.splice(F3, 1);
    }
  }), Q2(() => {
    Ve(v4.current.size ? v4.current : _3, ({ phase: y5, payload: T2 }, F3) => {
      let { ctrl: k4 } = F3;
      F3.phase = y5, m3 == null ? void 0 : m3.add(k4), L3 && y5 == "enter" && k4.start({ default: C3 }), T2 && (he2(k4, T2.ref), (k4.ref || m3) && !w2.current ? k4.update(T2) : (k4.start(T2), w2.current && (w2.current = false)));
    });
  }, o ? void 0 : n2);
  let N3 = (y5) => Oe2.createElement(Oe2.Fragment, null, c5.map((T2, F3) => {
    let { springs: k4 } = _3.get(T2) || T2.ctrl, O3 = y5({ ...k4 }, T2.item, T2, F3);
    return O3 && O3.type ? Oe2.createElement(O3.type, { ...O3.props, key: l2.str(T2.key) || l2.num(T2.key) ? T2.key : T2.ctrl.id, ref: O3.ref }) : O3;
  }));
  return m3 ? [N3, m3] : N3;
}
var er2 = 1;
...
function TextTransition(props) {
  var _a2 = props.direction, direction = _a2 === void 0 ? "up" : _a2, _b2 = props.inline, inline = _b2 === void 0 ? false : _b2, _c2 = props.springConfig, springConfig = _c2 === void 0 ? mt2.default : _c2, _d = props.delay, delay = _d === void 0 ? 0 : _d, className = props.className, style = props.style, _e3 = props.translateValue, tv = _e3 === void 0 ? "100%" : _e3, children = props.children;
  var initialRun = (0, import_react15.useRef)(true);
  var fromTransform = direction === "down" ? "-".concat(tv) : tv;
  var leaveTransform = direction === "down" ? tv : "-".concat(tv);
  var transitions = Gt2([children], {
  ...
  var _f = (0, import_react15.useState)(0), width = _f[0], setWidth = _f[1];
  var currentRef = (0, import_react15.useRef)(null);
  var heightRef = (0, import_react15.useRef)("auto");
  (0, import_react15.useEffect)(function() {
    initialRun.current = false;
    var element = currentRef.current;
    if (!element)
      return;
    var _a3 = element.getBoundingClientRect(), width2 = _a3.width, height = _a3.height;
    setWidth(width2);
    heightRef.current = height;
  }, [children, setWidth, currentRef]);
  var widthTransition = J2({
    to: { width },
    config: springConfig,
    immediate: initialRun.current,
    delay: !initialRun.current ? delay : void 0
  });
  return import_react15.default.createElement(it3.div, { className: "text-transition ".concat(className), style: __assign(__assign(__assign({}, inline && !initialRun.current ? widthTransition : void 0), style), { whiteSpace: inline ? "nowrap" : "normal", display: inline ? "inline-flex" : "flex", height: heightRef.current }) }, transitions(function(styles, item) {
    return import_react15.default.createElement(it3.div, { style: __assign({}, styles), ref: item === children ? currentRef : void 0, children: item });
  }));
}
...
// dep:react-text-transition
var react_text_transition_default = lib_esm_default;
export {
  react_text_transition_default as default,
  mt2 as presets
};
